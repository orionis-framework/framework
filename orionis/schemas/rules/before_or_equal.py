...
class BeforeOrEqual(Rule):
    """
    Ensure a date is equal to or comes before a reference moment.
    ...
    __message__ = "Value must be a date on or before the reference moment."
    __code__ = "before_or_equal"
